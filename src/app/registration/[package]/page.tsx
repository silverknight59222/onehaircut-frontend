			...
			<div>
				...
				<div className="flex flex-col md:flex-row items-center justify-center border-b border-[#EBF0F2] pb-3">
					...
					<div className="w-full flex items-center justify-center md:justify-end gap-4 sm:px-14">
						<button
							...
							className="w-52 sm:w-60 h-11 text-white font-semibold bg-background-gradient rounded-3xl"
						>
				...
				<div className="flex flex-col items-center justify-center mt-12 px-6 w-full overflow-hidden">
					<div className="flex flex-col xl:flex-row items-center md:items-start gap-11 w-full md:w-auto">
						<div className="mx-4">
							<p className="text-black font-medium text-3xl text-center md:text-left">Abonnement</p>
							<div
								className={`w-[350px] sm:w-[600px] h-44 sm:h-[130px] px-8 flex flex-col sm:flex-row items-start sm:items-center justify-center sm:justify-between my-7 rounded-xl ${selectedPlan === "regular" ? "bg-background-gradient text-white shadow-[0px_13px_38px_0px_rgba(180,180,180,0.42)]" : "bg-white text-black border border-[#D7D5D5]"
									}`}
							...
							<div className={`w-[350px] sm:w-[600px] h-44 sm:h-[130px] px-8 flex flex-col sm:flex-row items-start sm:items-center justify-center sm:justify-between rounded-xl ${selectedPlan === "pro" ? "bg-background-gradient text-white shadow-[0px_13px_38px_0px_rgba(180,180,180,0.42)]" : "bg-white text-black border border-[#D7D5D5]"
								}`}
					...
					<div className="relative video my-9 xl:ml-[400px] rounded-xl">
						<ReactPlayer  url='https://www.youtube.com/watch?v=OxgXJqyxlZA&pp=ygUFc2Fsb24%3D' poster='assets/poster.jpg' width="350px" height="250px"/>
					<p className="absolute bottom-5 text-white text-center w-full">{selectedPlan === "pro" ? 'Video ohc pro' : 'Video ohc regular'}</p>
					</div>
					<button className="text-white py-4 px-11 mb-9 xl:ml-56 font-semibold bg-background-gradient rounded-xl shadow-[0px_17px_36px_0px_rgba(255,125,60,0.25)]">
						Choisir cette offre
					</button>
				</div>
			</div>
