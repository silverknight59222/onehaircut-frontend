            ...
            {activity.map((item, index) => {
              return (
                ...
                >
                  ...
                  <td className="px-4 py-4 text-center underline cursor-pointer w-36">
                    Detail
                  </td>
                  <td
                    className={`px-4 py-4 text-center w-36 ${
                      item.status === "Effectuée"
                        ? "text-[#7ABF50]"
                        : item.status === "Demande de remboursement"
                        ? "text-[#FEA463]"
                        : item.status === "Remboursé(e)"
                        ? "text-[#ED4847]"
                        : ""
                    } `}
                  >
