...
const Subscription = () => {
  ...
  const upgradePlan = async () => {
    ...
    try {
      ...
      if (resp.data.status == 400) {
        ...
        if (
          resp.data.data.subscription &&
          resp.data.data.subscription.name == "OneHaircut Pro"
        ) {
          setIsCurrSubscriptionPro(true);
        } else {
          setIsCurrSubscriptionPro(false);
  ...
  const [
    ...
    setisConfirmationDowngradeModalOpen,
  ] = useState(false);
        ...
        <div className="z-0  flex-col xl:flex-row items-center xl:items-start justify-center gap-4 2xl:gap-12 mt-10 lg:mt-52">
          <div className="hidden lg:block relative">
            ...
            <div className="rounded-xl py-4 px-5">
              <div className="flex">
                ...
                {isCurrSubscriptionPro && (
                  <div className="w-48 absolute left-[230px] top-[650px]  flex items-center justify-center text-white font-semibold rounded-3xl -mb-12 h-12 bg-black cursor-not-allowed">
                ...
                {!isCurrSubscriptionPro && (
                  <div className="w-48 absolute left-[450px] top-[650px]  flex items-center justify-center text-white font-semibold rounded-3xl -mb-12 h-12 bg-black cursor-not-allowed">
                    {/* <div className={`${Theme_A.button.medBlackColoredButton} w-52 absolute left-[224px] top-[650px]  flex items-center justify-center`}> */}
                    Abo actuel
                  </div>
                )}
          ...
          <div className="relative z-0 w-full sm:w-[450px] flex flex-col  sm:-mt-5 lg:mt-20 xl:mt-20">
            ...
            <button
              ...
              className="w-40 h-10 flex items-center justify-center bg-[#ffffff] border border-black rounded-xl mt-20 mb-20 text-black font-normal hover:scale-95 transition-transform duration-300 hover:bg-stone-100 "
            >
              Clôturer le compte
            </button>
          </div>
      ...
      {isConfirmationDowngradeModalOpen && (
        <BaseModal close={closeConfirmationDowngradeModal}>
          <div className="modal-content text-center p-6">
            ...
            <p className="mb-4">
              Êtes-vous sûr de vouloir passer à l'abonnement gratuit ?
            </p>
            <p className="">
              Vous perdrez tous les avantages liés à l'abonnement Pro,
            </p>
            <p className="mb-4">
              y compris le nombre d'images que vous présentez aux clients.
            </p>
            <div className="flex justify-center gap-4 mt-8">
              {" "}
              {/* Ajout de flex et gap */}
              <button
      ...
      {isUpgradeModalOpen && (
        <BaseModal close={handleCloseUpgradeModal}>
          <div className="modal-content text-center p-6">
            ...
            <p className="mb-4">
              Félicitation, vous êtes sur le point de booster votre affaire
            </p>
            <img
