...
export const Theme_A = {
  ...
  button: {
    ...
    scrollToTheTopButton: `fixed bottom-20 sm:bottom-10 right-10 mb-8 p-4 bg-stone-300 text-sm text-white px-4 py-4 rounded-full transform hover:scale-105 transition-transform `,
    tourModalButton: `fixed bottom-20 sm:bottom-5 left-5 z-50 mb-8 p-4 bg-stone-800 text-sm text-white px-2 py-2 rounded-full transform hover:scale-110 transition-transform duration-300`,
